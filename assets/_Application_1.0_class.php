...
class Application {
	...
	function ConnectToDBMain() {
		$this->oDBMY = new clsDB();
		$this->db_main_connected = $this->oDBMY->connect();
		
	}
	function __construct ($application_type = "web") {
		$this->ui = new clsUI($application_type);
