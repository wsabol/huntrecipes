            ...
            for ($i = 0; $i < count($Type); $i++) {
                ...
                <td>
                    <label for="combine<?= $Type[$i]['id'] ?>">
                        <input type="checkbox" id="combine<?= $Type[$i]['id'] ?>" class="combine-check"
                               data-id="<?= $Type[$i]['id'] ?>" value=1>
                    </label>
                </td>
                <td>
                    <span class="btn btn-sm btn-primary btnTypeEdit" data-id="<?= $Type[$i]['id'] ?>"><i
                            class="fa fa-edit"></i></span>
                    <span class="btn btn-sm btn-success btnTypeView" data-id="<?= $Type[$i]['id'] ?>"><i
