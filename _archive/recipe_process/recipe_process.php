...
<div class="wrap clearfix">
    <header class="s-title">
        <h1>Recipe Input <small><?= $percent_done ?>% done /// projected_finish_date: <?= $data['finishdate'] ?></small>
        </h1>
    </header>
...
<script>
    ...
    function getNextText() {
        ...
        $.ajax({
            url: '/API/v0/recipe_process/ajax-json/get_next_text_packet.json.php',
            type: 'GET',
            data: {
    ...
    function getPrevText() {
        ...
        $.ajax({
            url: '/API/v0/recipe_process/ajax-json/get_prev_text_packet.json.php',
            type: 'GET',
            data: {
    ...
    function resetRecipeParentSelect() {
        $('#rParent').empty();
        $.ajax({
            url: '/API/v0/recipe_process/ajax-json/get_recipe_titles.json.php',
            type: 'GET',
    ...
    function resetIngredientDatalist() {
        ...
        $.ajax({
            url: '/API/v0/recipe_process/ajax-json/get_ingredients.json.php',
            type: 'GET',
    ...
    $(document).ready(function () {
        ...
        $('#divRawTextWrapper').on('click', '.buttonMarkComplete', function () {
            ...
            $.ajax({
                url: '/API/v0/recipe_process/ajax-json/mark_text_packet_as_complete.json.php',
                type: 'GET',
                data: {
